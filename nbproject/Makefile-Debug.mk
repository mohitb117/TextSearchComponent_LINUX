...
${OBJECTDIR}/TextFinderProject/CPPClientInterface.o: TextFinderProject/CPPClientInterface.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TextFinderProject/CPPClientInterface.o TextFinderProject/CPPClientInterface.cpp

${OBJECTDIR}/TextFinderProject/CPPClientInterface_TextComp.o: TextFinderProject/CPPClientInterface_TextComp.cpp 
	${MKDIR} -p ${OBJECTDIR}/TextFinderProject
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TextFinderProject/CPPClientInterface_TextComp.o TextFinderProject/CPPClientInterface_TextComp.cpp

${OBJECTDIR}/TextFinderProject/FileAnalyzer.o: TextFinderProject/FileAnalyzer.cpp 
	${MKDIR} -p ${OBJECTDIR}/TextFinderProject
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TextFinderProject/FileAnalyzer.o TextFinderProject/FileAnalyzer.cpp

${OBJECTDIR}/TextFinderProject/FileSystem.o: TextFinderProject/FileSystem.cpp 
	${MKDIR} -p ${OBJECTDIR}/TextFinderProject
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TextFinderProject/FileSystem.o TextFinderProject/FileSystem.cpp

${OBJECTDIR}/TextFinderProject/InputArgumentParser.o: TextFinderProject/InputArgumentParser.cpp 
	${MKDIR} -p ${OBJECTDIR}/TextFinderProject
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TextFinderProject/InputArgumentParser.o TextFinderProject/InputArgumentParser.cpp

${OBJECTDIR}/TextFinderProject/TextCompUtil.o: TextFinderProject/TextCompUtil.cpp 
	${MKDIR} -p ${OBJECTDIR}/TextFinderProject
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TextFinderProject/TextCompUtil.o TextFinderProject/TextCompUtil.cpp

${OBJECTDIR}/TextFinderProject/TextSearchComponent.o: TextFinderProject/TextSearchComponent.cpp 
	${MKDIR} -p ${OBJECTDIR}/TextFinderProject
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TextFinderProject/TextSearchComponent.o TextFinderProject/TextSearchComponent.cpp

${OBJECTDIR}/TextFinderProject/TextSearchFactory.o: TextFinderProject/TextSearchFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}/TextFinderProject
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TextFinderProject/TextSearchFactory.o TextFinderProject/TextSearchFactory.cpp
